...
void init_module() {
    ...
    printf("Successfully loaded all functions!\n");
}
...
int main() {
    ...
    mean_type *cur_mean;
    float *cur_array, *array_from_file;
    ...
    printf(" Mean from mean_type:           %10.3f\n",ret_mean_(cur_mean)); // return mean from sequential calculation
    printf(" Mean from ret_mean_from_array: %10.3f\n",ret_mean_from_array_(cur_array,&(head->ndata))); //return mean from instantaneous array calc
